export default function Button({children, link, type, databsdismiss, ...rest}) {
    return (
        <a href={link} className={`btn ${type ? `btn-${type}` : ''}`} target="_blank" data-bs-dismiss={databsdismiss} {...rest}>
            {children}
