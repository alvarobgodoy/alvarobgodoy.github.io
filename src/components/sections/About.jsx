...
import WorkImg from "/src/assets/work.svg"
import EducationImg from "/src/assets/education.svg"
        ...
        <div className="section_about" id="section_about">
            <div className="container">
                ...
                <div className="row second-row">
                    ...
                    <div className="col-sm-4">
                        <img className="icon" src={EducationImg} alt="Check" />
                        <h4>Education</h4>
                    ...
                    <div className="col-sm-4">
                        <img className="icon" src={WorkImg} alt="Check" />
                        <h4>Experience</h4>
                        <p>I had the opportunity to work for US-based clients for more than 2 years. Demonstrating my competence and ability to work in a team.</p>
                    </div>
                </div>
            </div>
        </div>
